              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-teal-500 to-teal-600 sm:px-10 xl:p-12">
                  ...
                  <ul className="mt-8 flex space-x-12">
                    <li>
                      <Link to="/" className="text-teal-200 hover:text-teal-100" href="#">
            ...
            <div className="space-y-8 xl:col-span-1">
              ...
              <div className="flex space-x-6">
                {footerNavigation.social.map((item) => (
                  <Link to="/" key={item.name} href={item.href} className="text-warm-gray-400 hover:text-warm-gray-300">
                ...
                <div>
                  ...
                  <ul className="mt-4 space-y-4">
                    {footerNavigation.solutions.map((item) => (
                      <li key={item.name}>
                        <Link to="/" href={item.href} className="text-base text-warm-gray-400 hover:text-warm-gray-300">
                          {item.name}
                       </Link>
                      </li>
                    ))}
